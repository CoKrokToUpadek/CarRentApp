...
public class AppUserSpringSecurityDetailsService implements UserDetailsService {

    private AppUserDetailsService carAppUserDetailsRepository;
    @Autowired
    public AppUserSpringSecurityDetailsService(AppUserDetailsService carAppUserDetailsRepository) {
